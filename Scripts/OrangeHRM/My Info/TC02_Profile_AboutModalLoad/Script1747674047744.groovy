...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/span_Admin User'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/a_About'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_OrangeHRM/h6_About'))
