...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_OrangeHRM/h6_Personal Details'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_OrangeHRM/h6_d LastNameTest'))
